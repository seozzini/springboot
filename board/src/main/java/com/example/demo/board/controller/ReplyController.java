...
public class ReplyController {
	...
	public String register(@Validated ReplyDTO reply,
			               BindingResult bindingResult,
			               RedirectAttributes rttr) {
		if(bindingResult.hasErrors()) { //유효성체크값에 하나라도 에러가 있으면
			return "reply/register"; // 폴더명/파일명
		}
		...
		return "redirect:/reply/list"; //위에 다 처리하고, redirect 만나면 재요청하라는 302와 주소를 보냄. client는 board/list 재요청 
	}
	...
	public String modify(Long rno, ReplyDTO reply, RedirectAttributes rttr) {
